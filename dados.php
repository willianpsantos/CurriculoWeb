...
&nbsp; &nbsp; &nbsp; &nbsp; Participei do projeto ENSINC MOBILE, onde desenvolvi uma versão mobile do portal universitário, a ser usado por professores e alunos das instituições que utilizam os sistemas da Efikase. Desenvolvi o projeto utlizando a tecnologias Apache Cordova, HTML, CSS, Javascript, jQuery e Kendo UI Mobile.";
